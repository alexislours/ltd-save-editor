<script lang="ts">
  ...
  import RestoreSessionModal from '$lib/RestoreSessionModal.svelte';
  ...
  import { bootRestoreScan } from '$lib/sessionRestore.svelte';
  import { flushAllPending } from '$lib/sessionPersist';
  import ThemeSwitcher from '$lib/ThemeSwitcher.svelte';
  import Toaster from '$lib/Toaster.svelte';
  import { TAB_PILL_CLASS } from '$lib/styles';
