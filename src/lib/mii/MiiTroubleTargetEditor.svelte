<script lang="ts">
  ...
  import { actorDisplay, allActors } from '../mapObjects/actors';
  import { foodByHash, foodImageUrl, foodLabel } from '../sav/foodList.svelte';
  import { safe } from '../sav/format';
  import { MII_SCHEMA } from '../sav/schema';
  import type { Trouble, TroubleTargetKey } from '../sav/troubleList.svelte';
  import { CARD_BASE_CLASS, FORM_INPUT_CLASS, LABEL_CLASS } from '../styles';
