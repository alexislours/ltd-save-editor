...
import type { DecodedRgba, FitMode } from '../textureEditor/textureReplaceState.svelte';
import { UGC_KINDS, listUgcSlots, type SidecarSource, type UgcKind } from '../shareMii';
import { hasOriginal } from '../shareMii/sidecarStore.svelte';
