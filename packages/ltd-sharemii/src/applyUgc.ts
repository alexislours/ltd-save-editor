import { arrayElementSize, DataType, type Accessor, buildHashMap } from '@alexislours/ltd-savedata';
import { PLAYER_SCHEMA, type SchemaLeaf } from '@alexislours/ltd-savedata/schema';
import { decodeLtdUgc, encodeLtdUgc, type LtdUgc } from './codec.js';
import { ShareMiiError } from './errors.js';
import { leafByHashOrThrow, type PlayerOnlySaves } from './savAccess.js';
import {
  UGC_ENABLE_HASHES,
  UGC_FILE_EXTENSIONS,
  UGC_HASHES,
